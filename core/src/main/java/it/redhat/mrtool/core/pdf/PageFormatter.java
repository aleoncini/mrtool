...
public class PageFormatter {
    ...
    public void formatHeaderInfo(Associate associate, String period, int monthDistance, int yearDistance) throws IOException {
    ...
    public void formatTripsTable(java.util.List<Trip> trips) throws IOException {
    ...
    private void writeLogs(java.util.List<Trip> trips) throws IOException {
        float H = 10;
